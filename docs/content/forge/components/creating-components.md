...
You can have a look at the default strategy used by the AutoAI Agent: [OneShotAgentPromptStrategy](https://github.com/RixyAI/AutoAI/tree/master/autoai/autoai/agents/prompt_strategies/one_shot.py), and how it's used in the [Agent](https://github.com/RixyAI/AutoAI/tree/master/autoai/autoai/agents/agent.py) (search for `self.prompt_strategy`).
...
The best place to see more examples is to look at the built-in components in the [autoai/components](https://github.com/RixyAI/AutoAI/tree/master/autoai/autoai/components/) and [autoai/commands](https://github.com/RixyAI/AutoAI/tree/master/autoai/autoai/commands/) directories.
