...
1. `pip install auto-ai-benchmarks`
...
1. clone the repo `auto-ai-benchmarks`
...
1. Navigate to `auto-ai-benchmarks/agent/mini-agi`
...
Manually created, existing challenges within auto-ai, https://osu-nlp-group.github.io/Mind2Web/
...
https://github.com/RixyAI/auto-ai-Benchmarks/pull/48/files
...
**For internal auto-ai ci runs**, specify the `AGENT_NAME` you want you use and set the `HOME_ENV`.
