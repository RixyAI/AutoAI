# AutoAI Flutter Client

## Description

This repository contains the Flutter client for the AutoAI project. The application facilitates users in discussing various tasks with a single agent. The app is built to be cross-platform and runs on Web, Android, iOS, Windows, and Mac.
...
1. **Clone the repo:**
```
git clone https://github.com/RixyAI/AutoAI.git
```
