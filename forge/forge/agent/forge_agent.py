...
class ForgeAgent(ProtocolAgent, BaseAgent):
    ...
    ForgeAgent provides component support; https://docs.auto.rixy.ai/forge/components/introduction/
    ...
    def __init__(self, database: AgentDB, workspace: FileStorage):
        ...
        # Built-in components:
        #   https://docs.auto.rixy.ai/forge/components/built-in-components/
    ...
    async def execute_step(self, task_id: str, step_request: StepRequestBody) -> Step:
        ...
        https://docs.auto.rixy.ai/forge/components/creating-components/

        Outdated tutorial on how to add custom logic:
        https://aiedge.medium.com/autoai-forge-e3de53cc58ec
    ...
    async def propose_action(self) -> ActionProposal:
        ...
        # Have a look at autoai/agents/agent.py for an example (complete_and_parse)
