...
async def assert_config_has_required_llm_api_keys(config: AppConfig) -> None:
        ...
        try:
            ...
            if "api_key" in str(e):
                ...
                logger.info(
                    ...
                    "https://docs.auto.rixy.ai/autoai/setup/#anthropic"
                )
    ...
    if set((config.smart_llm, config.fast_llm)).intersection(GroqModelName):
        ...
        try:
            ...
            logger.info(
                "For further instructions: https://docs.auto.rixy.ai/autoai/setup/#groq"
            )
            ...
            logger.info(
                ...
                "https://docs.auto.rixy.ai/autoai/setup/#groq"
            )
    ...
    if set((config.smart_llm, config.fast_llm)).intersection(OpenAIModelName):
        ...
        try:
            ...
            logger.info(
                "For further instructions: https://docs.auto.rixy.ai/autoai/setup/#openai"
            )
            ...
            logger.info(
                "For instructions to get and set a new API key: "
                "https://docs.auto.rixy.ai/autoai/setup/#openai"
            )
