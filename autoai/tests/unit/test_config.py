...
from autoai.app.config import GPT_3_MODEL, GPT_4_MODEL, AppConfig, ConfigBuilder
from autoai.app.configurator import apply_overrides_to_config
...
async def test_fallback_to_gpt3_if_gpt4_not_available(
    ...
    mock_list_models.return_value.set_result(
        AsyncPage(
            data=[Model(id=GPT_3_MODEL, created=0, object="model", owned_by="AutoAI")],
