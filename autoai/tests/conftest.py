...
from autoai.agents.agent import Agent, AgentConfiguration, AgentSettings
from autoai.app.config import AppConfig, ConfigBuilder
from autoai.app.main import _configure_llm_provider
...
def agent(
    ...
    agent_settings = AgentSettings(
        ...
        agent_id=f"AutoAI-test-agent-{str(uuid.uuid4())[:8]}",
